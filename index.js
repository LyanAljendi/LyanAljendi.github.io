...
function draw() {
    ...
    fill(c);
    textSize(20);
    text("Naive approach - without pruning", 30, 55);
    let col = color('gray');
    fill(col);
    textSize(17);
    text("To view the cell of one site, feel free to add as many sites as you wish,\nthen press 'compute cell' to calculate the cell of the first site ", 30, 100);
    textSize(13);
    text("Voronoi button shows all possible edges, before being pruned.", 30, 140)
    textSize(13);
    text("Complexity of this algorithm O( n2 log n )", 30, 200)
